...
export default function SpeciesStockError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[Species Stock Error]", error);
  }, [error]);
    ...
    <div className="p-8 flex items-center justify-center min-h-96">
      ...
      >
        ...
        <p className="text-sm mb-6" style={{ color: "var(--color-text-muted)" }}>
          Could not fetch inventory for this species. The database may be unreachable or RLS may be blocking the query.
        </p>
        {error.digest && (
